...
//Creating the api url link/ address
...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //Activating the task (in  the ServersCalling.swift file) to start
        task.resume()
        print("pass2")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        print("$$$$$$$$$$$$$$$$$$$: \(dataToReturn[(dataToReturn[indexPath.row].id) - 1].id)")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        //These werew the segue function transferes data. This is linked to the performSegue function. I think!!
